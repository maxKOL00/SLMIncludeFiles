...
class CGHAlgorithm {
    ...
    private:
        // Be careful when you change this order as the initializer list depends on
        ...
        const size_t first_nonzero_index;


        // FFT and main adaptive WGS-loop related vars
        cufftHandle fft_plan;
        cufftDoubleComplex* beam_amplitudes;
        ...
        // After this loop terminated the final phasemap is written to the externally
        // supplied phasemap array to be used for extending, correcting, displaying etc.
        void extract_final_phasemap(
            byte* phasemap
        ) const noexcept;
        ...
        // Because the stupid vimba api redefines even the simplest types the
        // return value of this function shows up as AVT::VmbAPI::UcharVector
        // instead of a simple std::vector<byte> or std::vector<unsigned char>
